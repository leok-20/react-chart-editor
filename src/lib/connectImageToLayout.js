...
export default function connectImageToLayout(WrappedComponent) {
  const ImageConnectedComponentContext = React.createContext({
  ...
  const ImageConnectedComponentChildContext = React.createContext({
    updateContainer: PropTypes.func,
  ...
  class ImageConnectedComponent extends Component {
    static contextType = ImageConnectedComponentContext;
